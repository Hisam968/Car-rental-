...
<title>Autonomous Vehicles | Car Listing</title>
<!--Bootstrap -->
...
<!-- Fav and touch icons -->
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="assets/images/favicon-icon/WAVE_car.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="assets/images/favicon-icon/WAVE_car.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="assets/images/favicon-icon/WAVE_car.png">
    <link rel="apple-touch-icon-precomposed" href="assets/images/favicon-icon/WAVE_car.png">
    <link rel="shortcut icon" href="assets/images/favicon-icon/WAVE_car.png">
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <p class="list-price">QAR <?php echo htmlentities($result->PricePerDay);?> Per Day</p>
            <ul>
...
{  ?>
              ...
              <li class="gray-bg">
                ...
                <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a>
                  <p class="widget_price">QAR <?php echo htmlentities($result->PricePerDay);?> Per Day</p>
                </div>
              </li>
              <?php }} ?>
